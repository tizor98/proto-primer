...
type TestServiceClient interface {
	...
	GetStudentsPerTest(ctx context.Context, in *GetStudentPerTestRequest, opts ...grpc.CallOption) (TestService_GetStudentsPerTestClient, error)
...
func (x *testServiceSetQuestionsClient) CloseAndRecv() (*ClientStreamResponse, error) {
...
func (x *testServiceEnrollStudentsClient) CloseAndRecv() (*ClientStreamResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(ClientStreamResponse)
...
func (c *testServiceClient) GetStudentsPerTest(ctx context.Context, in *GetStudentPerTestRequest, opts ...grpc.CallOption) (TestService_GetStudentsPerTestClient, error) {
...
type TestService_GetStudentsPerTestClient interface {
	Recv() (*proto_student.Student, error)
	grpc.ClientStream
}
...
func (x *testServiceGetStudentsPerTestClient) Recv() (*proto_student.Student, error) {
	m := new(proto_student.Student)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (x *testServiceTakeTestClient) Recv() (*TakeTestResponse, error) {
	m := new(TakeTestResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type TestServiceServer interface {
	...
	GetStudentsPerTest(*GetStudentPerTestRequest, TestService_GetStudentsPerTestServer) error
...
func (UnimplementedTestServiceServer) GetStudentsPerTest(*GetStudentPerTestRequest, TestService_GetStudentsPerTestServer) error {
...
func (x *testServiceSetQuestionsServer) SendAndClose(m *ClientStreamResponse) error {
...
func (x *testServiceEnrollStudentsServer) SendAndClose(m *ClientStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
type TestService_GetStudentsPerTestServer interface {
	Send(*proto_student.Student) error
	grpc.ServerStream
}
...
func (x *testServiceGetStudentsPerTestServer) Send(m *proto_student.Student) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *testServiceTakeTestServer) Send(m *TakeTestResponse) error {
	return x.ServerStream.SendMsg(m)
}
